...
public class Items {
    ...
    public static boolean elevatorOpen = false;
    public static boolean trapdoorOpen = false;
    public static boolean lasersOff = false;
    public static boolean lookingForModulanium = false;
    public static boolean seenMouseNote = false;
