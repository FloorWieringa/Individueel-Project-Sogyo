...
public class Player {
    ...
    public String retrieveComments(int id){
        ...
        switch(id){
            ...
            case 41:
                return "You take a look at the book 'Modulanium: the Secret to Modulating Your Own Success'. The first chapter is all about extracting pure liquid Modulanium from its natural compound. Scanning the pages, you understand what you'll need: in simple terms, not using any of the fancy names, you'll need to mix one cup of red liquid, two cups of orange, and one cup of green.";
            default:
                return " ";
        }
    }
