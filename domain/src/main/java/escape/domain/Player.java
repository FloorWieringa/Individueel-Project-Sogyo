    ...
    public String retrieveComments(int id){
        ...
        switch(id){
            case 1: //costume stand, untouched
                return "Now that you're getting a closer look at the costume stand, you see that this is Viperyon's backup costume. It's still sturdy and intimidating, but the colours are a lot more modest and the stitching more haphazard. The chest guard part looks like it opens up, and you notice a small panel around where the right ribs would be. There's a little screen there: it says, “Insert biological sample to activate.”";
            case 2: // chem table
            ...
            if (lasersOff == false){
                return "As you approach the centre of the room, you become aware of a faint humming in the air. You reach out with one hand for the rope/chair -– and instantly draw back in pain. Something burned you! Something invisible. There's some kind of barrier stopping you getting too close.";
            } 
            else {
